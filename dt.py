...
def runDT(X_train, X_test, y_train, y_test, data, path):
    ...
    # Plot learning curve
    learn_title = 'DT - Learning Curve (max_depth: %s) ' % bestParams['max_depth']
    ...
    complex_title = 'DT - Complexity Curve (max_depth: %s, ccp_alpha: %d) ' % (bestParams['max_depth'], bestParams['ccp_alpha'])
    ...
    labels = ("Training score", "Cross-validation score", "Maximum Depth Param", "Score")
